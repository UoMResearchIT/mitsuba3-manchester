...
class PhotonEmitter_1 final : public Emitter<Float, Spectrum> {
public:
    MI_IMPORT_BASE(Emitter, m_flags, m_medium, m_to_world)
    MI_IMPORT_TYPES(Scene, Texture)

    PhotonEmitter_1(const Properties &props) : Base(props) {
...
MI_IMPLEMENT_CLASS_VARIANT(PhotonEmitter_1, Emitter)
MI_EXPORT_PLUGIN(PhotonEmitter_1, "Photon emitter_1")
